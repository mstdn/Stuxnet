<template>
    <div>
        <div class="filter hover:brightness-[80%]">
            <img @click="openModal" class="h-full w-full rounded-lg" :src="post.file" />
        </div>
                            ...
                            <DialogPanel
                                ...
                                <DialogTitle as="h3"
                                    ...
                                    <div class="flex justify-start">
                                        <img class="inline-block h-9 w-9 mask mask-hexagon" :src="post.avatar" alt="" />
                                        <InertiaLink class="ml-2 mt-1"
                                            :href="route('user-profile', { id: post.username })">
                                            @{{ post.username }}
                                        </InertiaLink>
                                        <div class="m-1">・</div>
                                        <InertiaLink class="ml-1 mt-1" :href="route('projects.post', { id: post.id })">
                                            {{ post.time }}
                                        </InertiaLink>
                                    </div>
                                ...
                                <div class="mt-2">
                                    <InertiaLink :href="route('projects.post', { id: post.id })">
                                        <img class="object-fill h-full w-full rounded-lg" :src="post.file" alt="" />
                                    </InertiaLink>
                                </div>
                                <div class="mt-4">
