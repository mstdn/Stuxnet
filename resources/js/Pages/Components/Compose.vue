<template>
    <button type="button" @click="openModal" class="btn-link gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fed579"
                        ...
                        <DialogPanel
                            ...
                            <form @submit.prevent="submit">
                                ...
                                <!-- <div class="mt-2">
                                    ...
                                    <div v-if="form.errors.slug" v-text="form.errors.slug" class="text-red-500 mt-1">
                                    </div>
                                </div> -->
                                <div class="mt-2">
