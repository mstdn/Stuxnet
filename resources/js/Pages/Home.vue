...
<template>
    <AppLayout title="Home">
        ...
        <section>
            <div class="hero min-h-[500px] bg-base-200" style="background-image: url(/images/banner.jpg);">
        ...
        <section class="dark:bg-base-300">
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div class="max-w-screen-md mb-8 lg:mb-16">
                    ...
                    <p class="text-gray-800 sm:text-xl">Here at Flowbite we focus on markets where
        ...
        <section class="dark:bg-base-300">
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                <Link href="/projects"
                    ...
                    role="alert">
                    <span class="text-xs bg-base-300 rounded-full text-white px-4 py-1.5 mr-3">New</span> <span
                ...
                <h1
                    ...
                    Checkout my work</h1>
                <p class="mb-8 text-lg font-normal text-gray-800 lg:text-xl sm:px-16 xl:px-48">Here
